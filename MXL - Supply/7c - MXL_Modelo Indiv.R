...
### Set core controls
apollo_control = list(
  modelName  ="7c - MXL Modelo Indiv (bin)",
  modelDescr ="Modelo MXl de Indiv",
  mixing=TRUE,
  indivID    ="idLS",
  nCores = 3
)
...
database$Individualistas =0; database$Individualistas[database$Individualidad>0]<-1
