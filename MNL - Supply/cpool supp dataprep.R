...
NSE_CarPooling <- 
  read_excel("C:/Users/epugnalo/OneDrive - Telefonica/Documents/Investigador UCA/Carpooling BsAs/Scripts/MNL_Carpooling_Apollo/NSE CarPooling.xlsx", 
             sheet = "epanel")

dat0 = read.delim("C:/Users/epugnalo/OneDrive - Telefonica/Documents/Investigador UCA/Carpooling BsAs/Scripts/MNL_Carpooling_Apollo/cpSup_long_epanel.txt")
...
dat <- dat0 %>%
  ...
  mutate(modecar = as.numeric(RP03=='Auto/Camioneta <U+0096> manejando'),
        ...
        sec = case_when(CS4 == 'Pienso que es riesgoso' ~ 1,
                        CS4 == 'Pienso que puede ser inseguro' ~ 2,
                        CS4 == 'No s<e9>' ~ 3,
                        CS4 == 'Pienso que ser<e1> bastante seguro' ~ 4,
                        CS4 == 'Pienso que ser<e1> totalmente seguro' ~ 5)
  ...
  mutate(cE1_1 = E1.SQ001., 
         cE1_2 = -(E1.SQ002.)+8,  # inverted
         cE1_3 = E1.SQ003.,  
         cE1_6 = -(E1.SQ006.)+8,  # inverted
         cE1_5 = E1.SQ005.,
         ...
         #Sociability         
         cE3_1 = case_when( #Inverted. 
           E3.SQ001. == 'Para nada' ~ 5,
           E3.SQ001. == 'No muy bien' ~ 4,
           E3.SQ001. == 'Algo' ~ 3,
           E3.SQ001. == 'Bien' ~ 2,
           E3.SQ001. == 'Me describe muy bien' ~ 1),
         cE3_2 = case_when(
         ...
         cE3_3 = case_when(   #Inverted
           E3.SQ003. == 'Para nada' ~ 5,
           E3.SQ003. == 'No muy bien' ~ 4,
           E3.SQ003. == 'Algo' ~ 3,
           E3.SQ003. == 'Bien' ~ 2,
           E3.SQ003. == 'Me describe muy bien' ~ 1),
         cE3_4 = case_when(
         ...
         cE3_5 = case_when( #Inverted
           E3.SQ005. == 'Para nada' ~ 5,
           E3.SQ005. == 'No muy bien' ~ 4,
           E3.SQ005. == 'Algo' ~ 3,
           E3.SQ005. == 'Bien' ~ 2,
           E3.SQ005. == 'Me describe muy bien' ~ 1),
         cE3_6 = case_when(
         ...
         #EnviromentalConcern
         cE4_1 = case_when( #Inverted
           E4.SQ001. == 'Totalmente en desacuerdo' ~ 5,
           E4.SQ001. == 'Parcialmente en desacuerdo' ~ 4,
           E4.SQ001. == 'Indiferente' ~ 3,
           E4.SQ001. == 'Parcialmente de acuerdo' ~ 2,
           E4.SQ001. == 'Totalmente de acuerdo' ~ 1),
         cE4_2 = case_when( 
         ...
         cE4_3 = case_when( #Inverted
           E4.SQ003. == 'Totalmente en desacuerdo' ~ 5,
           E4.SQ003. == 'Parcialmente en desacuerdo' ~ 4,
           E4.SQ003. == 'Indiferente' ~ 3,
           E4.SQ003. == 'Parcialmente de acuerdo' ~ 2,
           E4.SQ003. == 'Totalmente de acuerdo' ~ 1),
         cE4_4 = case_when(
         ...
         cE4_5 = case_when( #Inverted
           E4.SQ005. == 'Totalmente en desacuerdo' ~ 5,
           E4.SQ005. == 'Parcialmente en desacuerdo' ~ 4,
           E4.SQ005. == 'Indiferente' ~ 3,
           E4.SQ005. == 'Parcialmente de acuerdo' ~ 2,
           E4.SQ005. == 'Totalmente de acuerdo' ~ 1),
         cE4_6 = case_when(
...
write.table(database,"cpSupp_wide_epanel.txt",sep='\t',dec='.')
...
#+ InterestCars (1,5,6)
dat = database[,c('cE1_1','cE1_2','cE1_3','cE1_5','cE1_6')]
pca = prcomp(dat, scale=TRUE, center=TRUE)
pca
biplot(pca)
pca$sdev^2/sum(pca$sdev^2)
psych::scree(dat,pc=T,factors=F,main="Scree plot",hline=1)

dat = database[,c('cE1_1','cE1_5','cE1_6')]
pca = prcomp(dat, scale=TRUE, center=TRUE)
pca
biplot(pca)
pca$sdev^2/sum(pca$sdev^2)
...
#+ Sociability (2,4,6,8)
dat = database[,c('cE3_1','cE3_2','cE3_3','cE3_4', 'cE3_5','cE3_6','cE3_7','cE3_8')]
pca = prcomp(dat, scale=TRUE, center=TRUE)
pca
biplot(pca)
pca$sdev^2/sum(pca$sdev^2)
...
dat = database[,c('cE3_2','cE3_4','cE3_6', 'cE3_8')]
pca = prcomp(dat, scale=TRUE, center=TRUE)
pca
biplot(pca)
pca$sdev^2/sum(pca$sdev^2)
...
#+ EnviromentalConcern (2,4,6)
dat = database[,c('cE4_1','cE4_2','cE4_3','cE4_4', 'cE4_5','cE4_6')]
pca = prcomp(dat, scale=TRUE, center=TRUE)
pca
biplot(pca)
pca$sdev^2/sum(pca$sdev^2)
...
dat = database[,c('cE4_2','cE4_4','cE4_6')]
pca = prcomp(dat, scale=TRUE, center=TRUE)
pca
biplot(pca)
pca$sdev^2/sum(pca$sdev^2)
