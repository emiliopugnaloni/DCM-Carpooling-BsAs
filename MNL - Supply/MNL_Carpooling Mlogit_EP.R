...
### Clear memory
rm(list = ls())
setwd("C:/Users/emiba/OneDrive/Documents/Investigador UCA/Carpooling BsAs/Scripts/MNL_Carpooling_Apollo")
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){  #esto es una funcion que se crea y al final retorna probabilidades
  ...
  V = list()
  V[['ca']] = asc_ca + b_time * time_ca + b_cost * cost_ca
  V[['cp']] = asc_cp + b_time * time_cp + b_cost * cost_cp
