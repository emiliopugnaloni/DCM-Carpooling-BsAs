...
### Set core controls
apollo_control = list(
  modelName  ="7d - MXL Modelo Sociabl (bin)",
  modelDescr ="Modelo MXl de Sociab (bin)",
  mixing=TRUE,
  indivID    ="idLS",
  nCores = 3
)
...
database$Sociables =0; database$Sociables[database$Individualidad<0]<-1
database$Ecologistas =0; database$Ecologistas[database$ecologia>0]<-1
...
#model = apollo_loadModel("7c - MXL Modelo Indiv (bin)")
