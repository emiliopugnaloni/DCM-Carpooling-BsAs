...
### Set core controls
apollo_control = list(
  modelName  ="1 - MXL Modelo Base",
  modelDescr ="Modelo MXl con B aleatorios. Y 1000 draws halton ",
  mixing=TRUE,
  indivID    ="idLS",
  nCores = 3
)
...
#     apollo_beta = apollo_readBeta(apollo_beta, apollo_fixed, "MXL Modelo Base", overwriteFixed=FALSE)
