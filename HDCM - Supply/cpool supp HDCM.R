...
### Set core controls
apollo_control = list(
  modelName  = "cpool supp HDCM 20230326",
  modelDescr = "Car Pooling Hybrid DCM (not mixed) 3000pmc. Estimations set due to Demand & Apollo 0.1.0 - ",
  indivID    = "ID",
  mixing     = TRUE,
  nCores     = 7
)
...
apollo_beta=c(b0ca = 0,
              ...
              #inician en mismo que demanda estos
...
apollo_fixed = c("b0ca")
apollo_beta = apollo_readBeta(apollo_beta, apollo_fixed, "MNL_CP_Apollo_20230324", overwriteFixed=FALSE) #levanto los de mnl
