...
### Clear memory
rm(list = ls())
setwd("C:/Users/emiba/OneDrive - UCA/Documentos/Investigador UCA/Carpooling BsAs/Scripts/MXL_Carpooling_Apollo_epanel")
